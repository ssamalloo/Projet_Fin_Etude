...
public class UploadActivity extends AppCompatActivity {
    ...
    Button saveButton;
    EditText uploadTopic, uploadDesc, uploadType;
    String imageURL;
    Uri uri;
                            ...
                            if (data != null) {
                                try {
                                    ...
                                    if (uri != null) {
                                        ...
                                        Toast.makeText(UploadActivity.this, "Unable to get image URI", Toast.LENGTH_SHORT).show();
                                    }
                                } catch (Exception e) {
                                    e.printStackTrace();
                                ...
                                Toast.makeText(UploadActivity.this, "No data received", Toast.LENGTH_SHORT).show();
                            }
                        } else {
    ...
    public void saveData(){
        ...
        StorageReference storageReference = FirebaseStorage.getInstance().getReference().child("topic")
    ...
    public void uploadData(){
        ...
        DataClass dataClass = new DataClass(title,desc,type,imageURL);

        String currentDate = DateFormat.getDateTimeInstance().format(Calendar.getInstance().getTime());

        FirebaseDatabase.getInstance().getReference("Topics").child(currentDate)
